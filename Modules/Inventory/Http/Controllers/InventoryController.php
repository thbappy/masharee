...
class InventoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:inventory-list|inventory-create|inventory-edit|inventory-delete|inventory-settings', ['only', ['index']]);
        ...
        $this->middleware('permission:inventory-settings', ['only', ['settings', 'settings_update']]);
    }
