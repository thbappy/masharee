                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex flex-wrap justify-content-between">
                            <h4 class="header-title mb-4">{{__('Digital Product All Language')}}</h4>
                            <div class="div">
                                @can('digital-author-create')
                                    <a href="#"
                                       data-bs-toggle="modal"
                                       data-bs-target="#category_create_modal"
                                       class="btn btn-sm btn-info mb-3 mr-1 text-light">{{__('New Language')}}</a>
                                @endcan
                            </div>
                        </div>
                                        ...
                                        <td>
                                            @can('digital-author-delete')
                                                <x-table.btn.swal.delete
                                                    :route="route('tenant.admin.digital.product.language.delete', $author->id)"/>
                                            @endcan
        ...
        <div class="modal fade" id="subcategory_edit_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('tenant.admin.digital.product.language.update') }}" method="post">
    ...
    @can('digital-author-create')
        <div class="modal fade" id="category_create_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{__('Create Language')}}</h5>
                        <button type="button" class="close" data-bs-dismiss="modal"><span>×</span></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('tenant.admin.digital.product.language.new') }}" method="post"
...
@section('scripts')
    ...
    <x-table.btn.swal.js/>
    @can('digital-author-delete')
        <x-bulk-action.js :route="route('tenant.admin.digital.product.language.bulk.action')"/>
    @endcan
