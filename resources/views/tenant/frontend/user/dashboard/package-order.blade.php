                ...
                @foreach($package_orders as $data)
                    <tr>
                                ...
                                <div class="div">
                                    ...
                                    <small class="d-block"><strong>{{__('Order Status:')}}</strong>
                                        ...
                                        @elseif($data->status == 'in_progress')
                                            <span class="alert alert-info text-capitalize alert-sm alert-small">{{__(str_replace('_',' ',$data->status))}}</span>
                                        @else
                        ...
                        <td>
                            ...
                            @else
                                <span class="alert alert-success text-capitalize " style="display: inline-block">{{__($data->payment_status)}}</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
