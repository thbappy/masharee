...
<div class="seller-profile-details-wrapper">
    <h3 class="title-seller"> {{__('Edit Password')}} </h3>
                ...
                <div class="dashboard-address-details">
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                            ...
                            <input class="form--control" type="password" name="old_password" id="old_password" placeholder="{{__('Old Password')}}">
                        </div>
                        <div class="single-info-input margin-top-30">
                        ...
                        <div class="single-info-input margin-top-30">
                            ...
                            <input class="form--control" type="password" name="password_confirmation" id="password_confirmation" placeholder="{{__('Confirm Password')}}">
                        </div>
                    </div>
                </div>
            </div>
