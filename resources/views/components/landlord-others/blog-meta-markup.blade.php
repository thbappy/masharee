    ...
    <div class="d-flex align-items-start mb-8 metainfo-inner-wrap">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="v-general-meta-info" role="tabpanel" >
                ...
                @if(old('meta_image'))
                    <x-fields.media-upload name="meta_image" title="{{__('Meta Image')}}" dimentions="1200x1200" id="{{old('meta_image')}}"/>
                @else
            ...
            <div class="tab-pane fade" id="v-facebook-meta-info" role="tabpanel" >
                ...
                @if(old('meta_fb_image'))
                    <x-fields.media-upload name="meta_fb_image" title="{{__('Meta Image')}}" dimentions="1200x1200" id="{{old('meta_fb_image')}}"/>
                @else
            ...
            <div class="tab-pane fade" id="v-twitter-meta-info" role="tabpanel" >
                ...
                @if(old('meta_tw_image'))
                    <x-fields.media-upload name="meta_tw_image" title="{{__('Meta Image')}}" dimentions="1200x1200" id="{{old('meta_tw_image')}}"/>
                @else
