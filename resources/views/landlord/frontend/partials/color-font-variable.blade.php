<style>
    :root {
        --main-color-one: {{get_static_option('main_color_one') ?? 'rgb(240, 72, 83)'}};
        --main-color-one-rgb: {{get_static_option('main_color_one') ? str_replace(['rgb','(',')'], '',get_static_option('main_color_one')) : '240, 72, 83'}};
