...
<section class="collection-area" data-padding-top="{{$data['padding_top']}}" @if($data['background_color']) style="background-color: {{$data['background_color']}}" @endif  data-padding-bottom="{{$data['padding_bottom']}}">
