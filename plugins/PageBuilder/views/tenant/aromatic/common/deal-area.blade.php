        ...
        <div class="deal-wrapper section-bg-2">
            ...
            <div class="deal-content">
                ...
                <div class="btn-wrapper mt-4">
                    <a href="{{empty($data['button_url']) ? route('tenant.campaign.index', $data['campaign']) : \App\Helpers\SanitizeInput::esc_url($data['button_url'])}}" class="cmn-btn cmn-btn-bg-2 radius-0"> {{$data['button_text']}} </a>
                </div>
            </div>
        </div>
    </div>
