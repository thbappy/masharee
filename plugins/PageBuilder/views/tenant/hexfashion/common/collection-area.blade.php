    ...
    <div class="container container-one">
        <div class="collection-wrapper">
            ...
            <div class="collection-wrapper-contents center-text bg-white">
                <span class="collection-wrapper-contents-subtitle color-two"> {{\App\Helpers\SanitizeInput::esc_html($data['subtitle']) ?? ''}} </span>
                <h2 class="collection-wrapper-contents-title mt-2"> {{\App\Helpers\SanitizeInput::esc_html($data['title']) ?? ''}} </h2>
